...
abbr nmc "nmcli --ask"
abbr wtf "curl --doh-url https://8.8.8.8/dns-query --connect-timeout 5 -fSs4 https://myip.wtf/json 2>/dev/null | jq"
abbr wtf6 "curl --doh-url https://8.8.8.8/dns-query --connect-timeout 5 -fSs6 https://myip.wtf/json 2>/dev/null | jq"
