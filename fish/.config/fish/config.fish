...
abbr nmc "nmcli --ask"
abbr wtf "curl --doh-url https://8.8.8.8/dns-query --connect-timeout 5 -fSs https://ipv4.json.myip.wtf 2>/dev/null | jq"
abbr wtf6 "curl --doh-url https://8.8.8.8/dns-query --connect-timeout 5 -fSs https://ipv6.json.myip.wtf 2>/dev/null | jq"
