...
apt update
apt install -y i3 i3blocks dunst curl wget alacritty ranger git gnupg xbanish feh picom xinit stow htop neovim tmux btop batcat ripgrep fish zoxide zathura
