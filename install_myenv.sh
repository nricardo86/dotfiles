...
sudo apt install -y i3 i3blocks eza rsync fontconfig autotiling dunst libbz2-dev libsqlite3-dev tk libffi-dev restic pass flameshot npm nodejs python3-venv gcc zip luarocks curl jq wget alacritty ranger git gnupg scdaemon vnstat acpi acpid xbanish feh picom xinit stow htop neovim tmux btop bat ripgrep fish zoxide zathura
